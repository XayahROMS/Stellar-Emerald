...
extern const u8 BattleScript_FaultyForecastRain[];
...
extern const u8 BattleScript_FaultyForecastSun[];
...
extern const u8 BattleScript_FaultyForecastHail[];
extern const u8 BattleScript_SnowWarningActivatesSnow[];
extern const u8 BattleScript_FaultyForecastSnow[];
...
extern const u8 BattleScript_HypnoOrb[];
extern const u8 BattleScript_FrigidOrb[];
...
extern const u8 BattleScript_FaultyForecastBlockedByPrimalWeather[];
