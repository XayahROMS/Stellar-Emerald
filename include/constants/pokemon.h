...
#define EVO_LEVEL_SUN                     50     // Pokémon reaches the specified level during sun in the overworld
#define EVO_LEVEL_NEW_MAUVILLE            51     // Pokémon reaches the specified level in New Mauville
