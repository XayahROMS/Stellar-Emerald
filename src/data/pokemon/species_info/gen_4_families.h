...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_GRASS, TYPE_GROUND, TYPE_ROCK),
        .catchRate = 45,
    ...
    [SPECIES_INFERNAPE] =
    {
        ...
        .baseSpAttack  = 104,
        .baseSpDefense = 71,
        .types = MON_TYPES(TYPE_FIRE, TYPE_FIGHTING, TYPE_PSYCHIC),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 267,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .baseSpAttack  = 111,
        .baseSpDefense = 101,
        .types = MON_TYPES(TYPE_WATER, TYPE_FLYING, TYPE_STEEL),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 265,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING, TYPE_FIGHTING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 243,
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_DARK, TYPE_WATER),
        .catchRate = 127,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .baseSpAttack  = 25,
        .baseSpDefense = 41,
        .types = MON_TYPES(TYPE_BUG, TYPE_NORMAL, TYPE_FAIRY),
        .catchRate = 255,
    ...
    [SPECIES_LUXRAY] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 79,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_FIGHTING, TYPE_DARK),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 262,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_ROCK, TYPE_FIGHTING, TYPE_DRAGON),
        .catchRate = 45,
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .baseSpAttack  = 47,
        .baseSpDefense = 138,
        .types = MON_TYPES(TYPE_ROCK, TYPE_STEEL, TYPE_PSYCHIC),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 173 : 199,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(12.5),
        ...
        .description = COMPOUND_STRING(
            ...
            "It seems its body evolved to defend.\n"
            "its surprisingly large mind."),
        .pokemonScale = 272,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WORMADAM_PLANT_CLOAK] =
    {
        ...
        .baseSpAttack  = 79,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_BUG, TYPE_GRASS, TYPE_FAIRY),
        .catchRate = 45,
    ...
    [SPECIES_WORMADAM_SANDY_CLOAK] =
    {
        ...
        .baseSpAttack  = 59,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_BUG, TYPE_GROUND, TYPE_WATER),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 148 : 159,
        .evYield_Defense = 2,
        .itemRare = ITEM_SILVER_POWDER,
    ...
    [SPECIES_WORMADAM_TRASH_CLOAK] =
    {
        ...
        .baseSpAttack  = 69,
        .baseSpDefense = 95,
        .types = MON_TYPES(TYPE_BUG, TYPE_STEEL, TYPE_POISON),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 148 : 159,
        .evYield_Defense = 1,
        .evYield_SpDefense = 1,
...
#define MOTHIM_SPECIES_INFO                                                 \
    {                                                                       \
        ...
        .baseSpAttack  = 94,                                                \
        .baseSpDefense = 50,                                                \
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING, TYPE_DARK),               \
        .catchRate = 45,                                                    \
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 148 : 159,            \
        .evYield_Attack = 1,                                                \
        .evYield_SpAttack = 1,                                              \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 42,
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING, TYPE_GRASS),
        .catchRate = 120,
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_GRASS, TYPE_DARK),
        .catchRate = 200,
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .weight = 295,
        .description = COMPOUND_STRING(
            "It inflates its flotation sac with hot air,\n"
            "keeping its face above water in order to\n"
            "watch for prey movement. It swims by\n"
            "rotating its two tails like a screw."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLOATZEL] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_WATER, TYPE_FIRE, TYPE_FIGHTING),
        .catchRate = 75,
        ...
        .description = COMPOUND_STRING(
            ...
            "as a rubber raft. The air inside is\n"
            "constantly heated so it stays afloat."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHERRIM_OVERCAST] =
    {
        ...
        .baseSpAttack  = 87,
        .baseSpDefense = 78,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FIRE, TYPE_FIGHTING),
        .catchRate = 75,
    ...
    [SPECIES_GASTRODON_WEST_SEA] =
    {
        ...
        .baseSpAttack  = 92,
        .baseSpDefense = 82,
        .types = MON_TYPES(TYPE_WATER, TYPE_ICE, TYPE_GROUND),
        .catchRate = 75,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .abilities = { ABILITY_AFTERMATH, ABILITY_UNBURDEN, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DRIFBLIM] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 54,
        .types = MON_TYPES(TYPE_GHOST, TYPE_FLYING, TYPE_FIRE),
        .catchRate = 60,
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .weight = 55,
        .description = COMPOUND_STRING(
            "Living in cold temperatures has caused\n"
            "its fur to thicken. It is often used\n"
            "for scarfs and mittens, though it\n"
            "is typically treated well by farmers."),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .baseSpAttack  = 54,
        .baseSpDefense = 96,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_ICE, TYPE_FIGHTING),
        .catchRate = 60,
        ...
        .weight = 333,
        .description = COMPOUND_STRING(
            "It is said that clothes made from\n"
            "a Lopunny's fur will be comfortable\n"
            "in any weather. Unfortunately, it is\n"
            "too aggressive to find out for sure."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .baseSpAttack  = 64,
        .baseSpDefense = 59,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_DARK, TYPE_ICE),
        .catchRate = 75,
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .baseSpAttack  = 71,
        .baseSpDefense = 61,
        .types = MON_TYPES(TYPE_POISON, TYPE_DARK, TYPE_FIRE),
        .catchRate = 60,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .baseSpAttack  = 24,
        .baseSpDefense = 86,
        .types = MON_TYPES(TYPE_STEEL, TYPE_PSYCHIC, TYPE_FLYING),
        .catchRate = 255,
        ...
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_HEATPROOF, ABILITY_HEAVY_METAL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .baseSpAttack  = 92,
        .baseSpDefense = 42,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING, TYPE_BUG),
        .catchRate = 30,
        ...
        .description = COMPOUND_STRING(
            ...
            "It is especially fond of Kricketune\n"
            "and often takes after it."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .baseSpAttack  = 92,
        .baseSpDefense = 108,
        .types = MON_TYPES(TYPE_GHOST, TYPE_DARK, TYPE_NORMAL),
        .catchRate = 100,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_GROUND, TYPE_ROCK),
        .catchRate = 45,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .baseSpAttack  = 115,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_FAIRY, TYPE_STEEL),
        .catchRate = 45,
    ...
    [SPECIES_HIPPOWDON] =
    {
        ...
        .baseSpAttack  = 68,
        .baseSpDefense = 72,
        .types = MON_TYPES(TYPE_GROUND, TYPE_DARK, TYPE_WATER),
        .catchRate = 60,
        ...
        .weight = 3000,
        .description = COMPOUND_STRING(
            "It is surprisingly quick to anger. It\n"
            "brandishes its gaping mouth in a display\n"
            "of fearsome strength and raises large\n"
            "amounts of sand and water while attacking."),
        .pokemonScale = 261,
        .pokemonOffset = 2,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_DRAPION] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_POISON, TYPE_BUG, TYPE_DARK),
        .catchRate = 45,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .baseSpAttack  = 61,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_POISON, TYPE_FIGHTING, TYPE_DARK),
        .catchRate = 140,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 72,
        .types = MON_TYPES(TYPE_GRASS, TYPE_GROUND, TYPE_STEEL),
        .catchRate = 200,
    ...
    [SPECIES_LUMINEON] =
    {
        ...
        .baseSpAttack  = 69,
        .baseSpDefense = 86,
        .types = MON_TYPES(TYPE_WATER, TYPE_FLYING, TYPE_GRASS),
        .catchRate = 75,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .baseSpAttack  = 62,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_GRASS, TYPE_ICE, TYPE_ROCK),
        .catchRate = 120,
    ...
    [SPECIES_ROTOM] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 77,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_GHOST, TYPE_NORMAL),
        .catchRate = 45,
    ...
    [SPECIES_ROTOM_HEAT] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 107,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_GHOST, TYPE_FIRE),
        .catchRate = 45,
    ...
    [SPECIES_ROTOM_WASH] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 107,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_GHOST, TYPE_WATER),
        .catchRate = 45,
        .expYield = ROTOM_APPLIANCE_EXP_YIELD,
        .evYield_Speed = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_ROTOM_FROST] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 107,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_GHOST, TYPE_ICE),
        .catchRate = 45,
        .expYield = ROTOM_APPLIANCE_EXP_YIELD,
        .evYield_Speed = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_ROTOM_FAN] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 107,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_GHOST, TYPE_FLYING),
        .catchRate = 45,
        .expYield = ROTOM_APPLIANCE_EXP_YIELD,
        .evYield_Speed = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 107,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_GHOST, TYPE_GRASS),
        .catchRate = 45,
        .expYield = ROTOM_APPLIANCE_EXP_YIELD,
        .evYield_Speed = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_UXIE] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 130,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_BUG, TYPE_ELECTRIC),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_MESPRIT] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_BUG, TYPE_FIRE),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_AZELF] =
    {
        ...
        .baseSpAttack  = 125,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_BUG, TYPE_GRASS),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .description = COMPOUND_STRING(
            ...
            "and Azelf all came from the same swarm."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_STEEL, TYPE_DRAGON, TYPE_PSYCHIC),
        .catchRate = 3,
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_WATER, TYPE_DRAGON, TYPE_PSYCHIC),
        .catchRate = 3,
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 106,
        .types = MON_TYPES(TYPE_FIRE, TYPE_STEEL, TYPE_DRAGON),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_GRASS, TYPE_GROUND),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 335,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_GHOST, TYPE_DRAGON, TYPE_DARK),
        .catchRate = 3,
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_GHOST, TYPE_DRAGON),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .weight = 856,
        .description = COMPOUND_STRING(
            "Those who sleep holding one of Cresselia's\n"
            "feathers are assured of joyful dreams.\n"
            "It can be surprisingly dangerous to those\n"
            "that wish to disrupt people's sleep."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_PHIONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_MANAPHY})
    },
    ...
    [SPECIES_MANAPHY] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_WATER, TYPE_GHOST, TYPE_FAIRY),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_DARK, TYPE_GHOST, TYPE_ICE),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .description = COMPOUND_STRING(
            ...
            "cold, nightmarish slumbers. However,\n"
            "it means no harm."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
    ...
    [SPECIES_SHAYMIN_LAND] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FIRE, TYPE_ICE),
        .catchRate = 45,
        ...
        .description = COMPOUND_STRING(
            ...
            "warmly hugged and senses gratitude. It\n"
            "reverts to this form when in contact with\n"
            "intense winters."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
    ...
    [SPECIES_SHAYMIN_SKY] =
    {
        ...
        .baseSpAttack  = 120,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FIRE, TYPE_FLYING),
        .catchRate = 45,
        .expYield = SHAYMIN_EXP_YIELD,
