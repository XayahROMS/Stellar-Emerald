...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_GRASS, TYPE_DRAGON, TYPE_ELECTRIC),
        .catchRate = 45,
        ...
        .description = COMPOUND_STRING(
            ...
            "plants. Its tail stores sunlight, which it\n"
            "can then discharge as electricity."),
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 275,
        .trainerOffset = 2,
    ...
    [SPECIES_COMBUSKEN] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_FIRE, TYPE_FLYING, TYPE_FIGHTING),
        .catchRate = 45,
        .expYield = 142,
        .evYield_Attack = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_SWAMPERT] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_WATER, TYPE_GROUND, TYPE_STEEL),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 268,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_DARK, TYPE_NORMAL, TYPE_FIRE),
        .catchRate = 127,
        ...
        .weight = 370,
        .description = COMPOUND_STRING(
            "Mightyena gives obvious signals when it\n"
            "is preparing to attack. It starts to growl\n"
            "deeply and then flattens its body. Its fangs\n"
            "are hot enough to ignite wood in one bite."),
        .pokemonScale = 362,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LINOONE] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 61,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_GRASS, TYPE_GHOST),
        .catchRate = 90,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 147 : 128,
        .evYield_Speed = 2,
        .itemCommon = ITEM_POTION,
    ...
    [SPECIES_OBSTAGOON] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 81,
        .types = MON_TYPES(TYPE_DARK, TYPE_NORMAL, TYPE_FIGHTING),
        .catchRate = 45,
        .expYield = 260,
        .evYield_Defense = 3,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SILCOON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "In this stage, it is not considered to\n"
            "be entirely alive."),
        .pokemonScale = 431,
        .pokemonOffset = 19,
        .trainerScale = 256,
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_BUG, TYPE_GHOST, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 198,
        ...
        .description = COMPOUND_STRING(
            ...
            "most prominent feature. Some cultures\n"
            "believe them to be the spirits of painters.\n"
            "from ages past."),
        .pokemonScale = 298,
        .pokemonOffset = -1,
        .trainerScale = 256,
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 193,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_LOMBRE] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_WATER, TYPE_GRASS, TYPE_GROUND),
        .catchRate = 120,
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_GRASS, TYPE_DARK, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 240,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_SWELLOW] =
    {
        ...
        .weight = 198,
        .description = COMPOUND_STRING(
            "It takes to the skies in search of lands\n"
            "with a warm climate. Their return is often\n"
            "often seen as the first sign of spring.\n"
            "Some people credit them with its arrival."),
        .pokemonScale = 428,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PELIPPER] =
    {
        ...
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_WATER, TYPE_FLYING, TYPE_ROCK),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 154,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .description = COMPOUND_STRING(
            ...
            "When it spots prey, it uses its large, stone\n"
            "beak to scoop up the victim with water.\n"
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GARDEVOIR] =
    {
        ...
        .baseSpAttack  = 125,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_PSYCHIC, RALTS_FAMILY_TYPE2, TYPE_FIRE),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 259,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .weight = 484,
        .description = COMPOUND_STRING(
            "To protect its Trainer, it will expend\n"
            "all its psychic power to ignite the air\n"
            "around it. It will give its life to\n"
            "do so if necessary."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_GALLADE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_FIGHTING, TYPE_WATER),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 259,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .description = COMPOUND_STRING(
            ...
            "It is sometimes said its moves like a\n."
            "flowing river during combat."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .baseSpDefense = 82,
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING, TYPE_FLYING),
        .catchRate = 75,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 159,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_GRASS, TYPE_GROUND, TYPE_FIGHTING),
        .catchRate = 90,
    ...
    [SPECIES_SLAKING] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FIGHTING, TYPE_POISON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 285,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_NINJASK] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_BUG, TYPE_GROUND, TYPE_FLYING),
        .catchRate = 120,
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_BUG, TYPE_GROUND, TYPE_GHOST),
        .catchRate = 45,
    ...
    [SPECIES_EXPLOUD] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL, TYPE_ELECTRIC, TYPE_DRAGON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 245,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "else. If you hear quaking rumbles near a,\n"
            "beach or while out at sea, it is the sound\n"
            "of Makuhita undertaking strenuous training."),
        .pokemonScale = 256,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HARIYAMA] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_WATER, TYPE_ELECTRIC),
        .catchRate = 200,
        ...
        .weight = 2538,
        .description = COMPOUND_STRING(
            "It commonly joins on various voyages over\n"
            "sea, though few know why. It seems to grow\n"
            "excited in thunderstorms, increasing the\n"
            "intensity of its training with each rumble."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 343,
        .trainerOffset = 7,
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 150,
        .types = MON_TYPES(TYPE_ROCK, TYPE_STEEL, TYPE_FLYING),
        .catchRate = 60,
    ...
    [SPECIES_SKITTY] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 35,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FAIRY, TYPE_ICE),
        .catchRate = 255,
        ...
        .abilities = { ABILITY_REFRIGERATE, ABILITY_NORMALIZE, ABILITY_PIXILATE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_DARK, TYPE_GHOST, TYPE_ROCK),
        .catchRate = 45,
    ...
    #define MAWILE_TYPES { TYPE_STEEL, TYPE_FAIRY, TYPE_DRAGON }
#else
    ...
    [SPECIES_AGGRON] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_STEEL, TYPE_ROCK, TYPE_DRAGON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 265,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_AGGRON_MEGA] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_ROCK, TYPE_STEEL, TYPE_DRAGON),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 315 : 284,
        .evYield_Defense = 3,
        .itemRare = ITEM_HARD_STONE,
    ...
    [SPECIES_MEDICHAM] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_PSYCHIC, TYPE_GHOST),
        .catchRate = 90,
    ...
    [SPECIES_MANECTRIC] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_FIRE, TYPE_DARK),
        .catchRate = 45,
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_GRASS, TYPE_FIRE),
        .catchRate = 200,
    ...
    [SPECIES_MINUN] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_GRASS, TYPE_ICE),
        .catchRate = 200,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 142 : 120,
        .evYield_Speed = 1,
        .itemRare = ITEM_CELL_BATTERY,
        ...
        .weight = 42,
        .description = COMPOUND_STRING(
            "Minun is more concerned about cheering on\n"
            "its partners than its own safety. It shorts\n"
            "out the electricity in its body to create\n"
            "showers of diamond dust to bring joy."),
        .pokemonScale = 512,
        .pokemonOffset = -7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_ELECTRIC, TYPE_DRAGON),
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .baseSpAttack  = 73,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 85 : 75,
        .types = MON_TYPES(TYPE_BUG, TYPE_ELECTRIC, TYPE_FAIRY),
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_ROSERADE] =
    {
        ...
        .baseSpAttack  = 125,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON, TYPE_ROCK),
        .catchRate = 75,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 258,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
        ...
        .description = COMPOUND_STRING(
            ...
            "it strikes with stone whips that are \n"
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .baseSpAttack  = 43,
        .baseSpDefense = 53,
        .types = MON_TYPES(TYPE_POISON, TYPE_BUG, TYPE_NORMAL),
        .catchRate = 225,
    ...
    [SPECIES_SHARPEDO] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_WATER, TYPE_DARK, TYPE_DRAGON),
        .catchRate = 60,
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .weight = 1300,
        .description = COMPOUND_STRING(
            "Intense heat in this Pokemon's large body\n"
            "expands the air inside, causing it to be\n"
            "surprisingly light. They tend to live\n"
    ...
    [SPECIES_WAILORD] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_WATER, TYPE_FIRE, TYPE_FLYING),
        .catchRate = 60,
        ...
        .weight = 3980,
        .description = COMPOUND_STRING(
            "The expanding air within has caused\n"
            "this Pokémon to be lighter than air.\n"
            "It can decrease its height by\n"
            "releasing water it stores."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 1352,
        .trainerOffset = 18,
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_FIRE, TYPE_GROUND, TYPE_WATER),
        .catchRate = 150,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 161 : 175,
        .evYield_Attack = 1,
        .evYield_SpAttack = 1,
        ...
        .description = COMPOUND_STRING(
            ...
            "a volcano. Every 10 years, the geysers\n"
    ...
    [SPECIES_CAMERUPT_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "into one large and very active geyser. It\n"
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_FIRE, TYPE_POISON, TYPE_STEEL),
        .catchRate = 90,
    ...
    [SPECIES_GRUMPIG] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_POISON, TYPE_DRAGON),
        .catchRate = 60,
    ...
    [SPECIES_SPINDA] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_POISON, TYPE_FIRE),
        .catchRate = 255,
        ...
        .description = COMPOUND_STRING(
            ...
            "unsteady, tottering walk is caused by\n"
            "the dense presence of toxins in its system."),
        .pokemonScale = 321,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_GROUND, TYPE_BUG, TYPE_DRAGON),
        .catchRate = 120,
    ...
    [SPECIES_CACTURNE] =
    {
        ...
        .baseSpAttack  = 115,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_GRASS, TYPE_DARK, TYPE_STEEL),
        .catchRate = 60,
        ...
        .description = COMPOUND_STRING(
            ...
            "the same small metals often found in sand.\n"
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_FAIRY, TYPE_FLYING, TYPE_DRAGON),
        .catchRate = 45,
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FIGHTING, TYPE_PSYCHIC),
        .catchRate = 90,
        ...
        .description = COMPOUND_STRING(
            ...
            "forelegs. Its fur bristles if it senses\n"
            "any nearby Seviper."),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_POISON, TYPE_DRAGON, TYPE_STEEL),
        .catchRate = 90,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 160 : 165,
        .evYield_Attack = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_ROCK, TYPE_PSYCHIC, TYPE_GHOST),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 161,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_SOLROCK] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_ROCK, TYPE_PSYCHIC, TYPE_DRAGON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 161,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        .baseSpAttack  = 76,
        .baseSpDefense = 71,
        .types = MON_TYPES(TYPE_WATER, TYPE_GROUND, TYPE_FLYING),
        .catchRate = 75,
        ...
        .description = COMPOUND_STRING(
            ...
            "feeds on birds by leaping out of the water."),
        .pokemonScale = 317,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CRAWDAUNT] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_WATER, TYPE_BUG, TYPE_DARK),
        .catchRate = 155,
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_GROUND, TYPE_PSYCHIC, TYPE_GHOST),
        .catchRate = 255,
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .baseSpAttack  = 61,
        .baseSpDefense = 87,
        .types = MON_TYPES(TYPE_ROCK, TYPE_GRASS, TYPE_WATER),
        .catchRate = 45,
    ...
    [SPECIES_ANORITH] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_ROCK, TYPE_BUG, TYPE_WATER),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_5
        .expYield = 71,
    #elif P_UPDATED_EXP_YIELDS >= GEN_4
    ...
    [SPECIES_FEEBAS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "polluted. Because of its hopelessly\n"
            "shabby appearance, it seems as if\n"
            "few Trainers raise it."),
        .pokemonScale = 423,
        .pokemonOffset = -4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 125,
        .types = MON_TYPES(TYPE_WATER, TYPE_POISON, TYPE_FAIRY),
        .catchRate = 60,
    ...
    [SPECIES_CASTFORM_NORMAL] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_FIRE, TYPE_ICE, TYPE_WATER),
        .catchRate = 45,
        ...
        .abilities = { ABILITY_FAULTY_FORECAST, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_KECLEON] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_GHOST, TYPE_DRAGON),
        .catchRate = 200,
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .baseSpAttack  = 83,
        .baseSpDefense = 63,
        .types = MON_TYPES(TYPE_GHOST, TYPE_NORMAL, TYPE_STEEL),
        .catchRate = 45,
        ...
        .weight = 125,
        .description = COMPOUND_STRING(
            "An abandoned metal doll became this\n"
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "only a spectral core of ice inside.\n"
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 135,
        .types = MON_TYPES(TYPE_GHOST, TYPE_ICE, TYPE_FIGHTING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 263,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_TROPIUS] =
    {
        ...
        .baseSpAttack  = 72,
        .baseSpDefense = 87,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FLYING, TYPE_DRAGON),
        .catchRate = 200,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AMPLIFIER, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_FLYING, TYPE_POISON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 159,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .description = COMPOUND_STRING(
            ...
            "hollow body. When this Pokémon becomes\n"
            "enraged, its cries result in ultrasonic waves\n"
            "that have the power to knock foes flying."),
        .pokemonScale = 505,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_DARK, TYPE_FAIRY, TYPE_ICE),
        .catchRate = 30,
        ...
        .description = COMPOUND_STRING(
            ...
            "the sky and the temperature to predict\n"
            "natural disasters. It is a long-lived\n"
            "Pokémon that has a life-span of 100 years."),
        .pokemonScale = 301,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_ICE, TYPE_DARK, TYPE_ROCK),
        .catchRate = 75,
    ...
    [SPECIES_GLALIE_MEGA] =
    {
        ...
        .baseSpAttack  = 120,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_ICE, TYPE_DARK, TYPE_ICE),
        .catchRate = 75,
        .expYield = 203,
        .evYield_HP = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_ICE, TYPE_GHOST, TYPE_FAIRY),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 168 : 187,
        .evYield_Speed = 2,
        .genderRatio = MON_FEMALE,
    ...
    [SPECIES_SEALEO] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_ICE, TYPE_WATER, TYPE_DARK),
        .catchRate = 120,
    ...
    [SPECIES_HUNTAIL] =
    {
        ...
        .baseSpAttack  = 94,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_WATER, TYPE_DARK, TYPE_GRASS),
        .catchRate = 60,
        ...
        .description = COMPOUND_STRING(
            ...
            "thick and sturdy. It agressively guards\n"
            "the coral reef it calls home."),
        .pokemonScale = 307,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .baseSpAttack  = 114,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_WATER, TYPE_FAIRY, TYPE_FIRE),
        .catchRate = 60,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 170 : 178,
        .evYield_SpAttack = 2,
        ...
        .description = COMPOUND_STRING(
            ...
            "pink body color is caused by a high body\n"
            "temperature."),
        .pokemonScale = 278,
        .pokemonOffset = 5,
        .trainerScale = 256,
    ...
    [SPECIES_RELICANTH] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_WATER, TYPE_ROCK, TYPE_STEEL),
        .catchRate = 25,
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_WATER, TYPE_FAIRY, TYPE_DARK),
        .catchRate = 225,
    ...
    [SPECIES_SALAMENCE] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_STEEL, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_METAGROSS] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_STEEL, TYPE_PSYCHIC, TYPE_GRASS),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .description = COMPOUND_STRING(
            ...
            "by a complex neural network. It often\n"
            "offers guidance on efficient farming,\n"
            "which it is better at than humans."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 447,
        .trainerOffset = 9,
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_ROCK, TYPE_GROUND, TYPE_NORMAL),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_REGICE] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 200,
        .types = MON_TYPES(TYPE_ICE, TYPE_GROUND, TYPE_NORMAL),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 150,
        .types = MON_TYPES(TYPE_STEEL, TYPE_GROUND, TYPE_NORMAL),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 130,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_PSYCHIC, TYPE_FIRE),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_LATIOS] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_PSYCHIC, TYPE_FLYING),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_KYOGRE] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 140,
        .types = MON_TYPES(TYPE_WATER, TYPE_ICE, TYPE_ELECTRIC),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 335,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_GROUDON] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_GROUND, TYPE_FIRE, TYPE_GRASS),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 335,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_RAYQUAZA] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_FLYING, TYPE_FIGHTING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 340,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_JIRACHI] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_STEEL, TYPE_PSYCHIC, TYPE_ICE),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .description = COMPOUND_STRING(
            ...
            "While it sleeps, a tough frozen shell\n"
            "crysallizes around the body to protect\n"
            "it from enemies."),
        .pokemonScale = 608,
        .pokemonOffset = -8,
        .trainerScale = 256,
    ...
    [SPECIES_DEOXYS_NORMAL] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_BUG, TYPE_DRAGON),
        .catchRate = 3,
