...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESNAUGHT] =
    {
        ...
        .baseSpAttack  = 74,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_GRASS, TYPE_STEEL, TYPE_FIGHTING),
        .catchRate = 45,
    ...
    [SPECIES_DELPHOX] =
    {
        ...
        .baseSpAttack  = 114,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_FIRE, TYPE_PSYCHIC, TYPE_GROUND),
        .catchRate = 45,
    ...
    [SPECIES_GRENINJA] =
    {
        ...
        .baseSpAttack  = 103,
        .baseSpDefense = 71,
        .types = MON_TYPES(TYPE_WATER, TYPE_DARK, TYPE_GHOST),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 265 : 239,
        .evYield_Speed = 3,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_DIGGERSBY] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 77,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_GROUND, TYPE_POISON),
        .catchRate = 127,
        .expYield = 148,
        .evYield_HP = 2,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .description = COMPOUND_STRING(
            ...
            "bedrock to rubble. This is only helped\n"
            "by acid it releases from the sack on\n"
            "its stomach to up the ground."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_TALONFLAME] =
    {
        ...
        .baseSpAttack  = 74,
        .baseSpDefense = 69,
        .types = MON_TYPES(TYPE_FIRE, TYPE_FLYING, TYPE_STEEL),
        .catchRate = 45,
        .expYield = 175,
        .evYield_Speed = 3,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .description = COMPOUND_STRING(
            ...
            "feathers and takes to the air. Planes\n"
            "were modeled off of this structure."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
        ...
        .baseSpAttack  = 90,                                                                \
        .baseSpDefense = 50,                                                                \
        .types = MON_TYPES(TYPE_BUG, TYPE_FAIRY, TYPE_FLYING),                              \
        .catchRate = 45,                                                                    \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_MALE, 35, SPECIES_PYROAR},
                                {EVO_LEVEL_FEMALE, 35, SPECIES_PYROAR_FEMALE}),
    },
    ...
    [SPECIES_PYROAR] =
    {
        ...
        .baseSpAttack  = 109,
        .baseSpDefense = 66,
        .types = MON_TYPES(TYPE_FIRE, TYPE_NORMAL, TYPE_DRAGON),
        .catchRate = 65,
        .expYield = 177,
        .evYield_SpAttack = 2,
    ...
    [SPECIES_PYROAR_FEMALE] =
    {
        ...
        .baseSpAttack  = 109,
        .baseSpDefense = 66,
        .types = MON_TYPES(TYPE_FIRE, TYPE_NORMAL, TYPE_FAIRY),
        .catchRate = 65,
        .expYield = 177,
        .evYield_SpAttack = 2,
...
#define FLOETTE_MISC_INFO(form, FORM, iconPal)                                  \
        .types = MON_TYPES(TYPE_FAIRY, TYPE_GRASS, TYPE_PSYCHIC),               \
        .catchRate = 120,                                                       \
        .evYield_SpDefense = 2,                                                 \
        .genderRatio = MON_FEMALE,                                              \
        .eggCycles = 20,                                                        \
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_GOGOAT] =
    {
        ...
        .baseSpAttack  = 97,
        .baseSpDefense = 81,
        .types = MON_TYPES(TYPE_GRASS, TYPE_NORMAL, TYPE_STEEL),
        .catchRate = 45,
        .expYield = 186,
        .evYield_HP = 2,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .weight = 910,
        .description = COMPOUND_STRING(
            "Its metal horns can sens subtle charges from\n"
            "its trainers grip, allowing it to sense how\n"
            "they are feeling. This empathetic sense lets\n"
            "them run as if one being."),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_PANGORO] =
    {
        ...
        .baseSpAttack  = 69,
        .baseSpDefense = 71,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_GRASS, TYPE_DARK),
        .catchRate = 65,
        .expYield = 173,
        .evYield_Attack = 2,
        .itemRare = ITEM_MENTAL_HERB,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    {                                                                                                   \
        ...
        .baseSpAttack  = 65,                                                                            \
        .baseSpDefense = 90,                                                                            \
        .types = MON_TYPES(TYPE_NORMAL, TYPE_STEEL, TYPE_DRAGON),                                       \
        .catchRate = 160,                                                                               \
        .expYield = 165,                                                                                \
        .evYield_Speed = 1,                                                                             \
        .genderRatio = PERCENT_FEMALE(50),                                                              \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "everything within 300 feet with lightning.\n"
    ...
    [SPECIES_MEOWSTIC_MALE] =
    {
        ...
        .baseSpAttack  = 83,
        .baseSpDefense = 81,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_ELECTRIC, TYPE_GHOST),
        .catchRate = 75,
        .expYield = 163,
        .evYield_Speed = 2,
        .genderRatio = MON_MALE,
    ...
    [SPECIES_MEOWSTIC_FEMALE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "aggressive than males. If they don't\n"
            "get what they want, they will haunt\n"
            "your dreams with their psychic abilities."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HONEDGE] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 37,
        .types = MON_TYPES(TYPE_STEEL, TYPE_GHOST, TYPE_FIGHTING),
        .catchRate = 180,
        .expYield = 65,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .baseSpAttack  = 63,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_FAIRY, TYPE_POISON, TYPE_PSYCHIC),
        .catchRate = 200,
        .expYield = 68,
        .evYield_HP = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .baseSpAttack  = 59,
        .baseSpDefense = 57,
        .types = MON_TYPES(TYPE_FAIRY, TYPE_POISON, TYPE_BUG),
        .catchRate = 200,
        .expYield = 68,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_INKAY] =
    {
        ...
        .baseSpAttack  = 37,
        .baseSpDefense = 46,
        .types = MON_TYPES(TYPE_DARK, TYPE_PSYCHIC, TYPE_WATER),
        .catchRate = 190,
        .expYield = 58,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_BARBARACLE] =
    {
        ...
        .baseSpAttack  = 54,
        .baseSpDefense = 86,
        .types = MON_TYPES(TYPE_ROCK, TYPE_WATER, TYPE_GROUND),
        .catchRate = 45,
        .expYield = 175,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_DRAGALGE] =
    {
        ...
        .baseSpAttack  = 97,
        .baseSpDefense = 123,
        .types = MON_TYPES(TYPE_POISON, TYPE_WATER, TYPE_DRAGON),
        .catchRate = 55,
        .expYield = 173,
        .evYield_SpDefense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_CLAWITZER] =
    {
        ...
        .baseSpAttack  = 120,
        .baseSpDefense = 89,
        .types = MON_TYPES(TYPE_WATER, TYPE_FIRE, TYPE_DRAGON),
        .catchRate = 55,
        .expYield = 100,
        .evYield_SpAttack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .baseSpAttack  = 61,
        .baseSpDefense = 43,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_NORMAL, TYPE_FIRE),
        .catchRate = 190,
        .expYield = 58,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_TYRANTRUM] =
    {
        ...
        .baseSpAttack  = 69,
        .baseSpDefense = 59,
        .types = MON_TYPES(TYPE_ROCK, TYPE_DRAGON, TYPE_DARK),
        .catchRate = 45,
        .expYield = 182,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_AURORUS] =
    {
        ...
        .baseSpAttack  = 99,
        .baseSpDefense = 92,
        .types = MON_TYPES(TYPE_ROCK, TYPE_ICE, TYPE_FAIRY),
        .catchRate = 45,
        .expYield = 104,
        .evYield_HP = 2,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_HAWLUCHA] =
    {
        ...
        .baseSpAttack  = 74,
        .baseSpDefense = 63,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_FLYING, TYPE_FAIRY),
        .catchRate = 100,
        .expYield = 175,
        .evYield_Attack = 2,
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .baseSpAttack  = 81,
        .baseSpDefense = 67,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_FAIRY, TYPE_GROUND),
        .catchRate = 180,
        .expYield = 151,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_GOODRA] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 150,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_POISON, TYPE_FAIRY),
        .catchRate = 45,
    ...
    [SPECIES_GOODRA_HISUIAN] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 150,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_STEEL, TYPE_GHOST),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_SpDefense = 3,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_KLEFKI] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 87,
        .types = MON_TYPES(TYPE_STEEL, TYPE_FAIRY, TYPE_NORMAL),
        .catchRate = 75,
        .expYield = 165,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_TREVENANT] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 82,
        .types = MON_TYPES(TYPE_GHOST, TYPE_GRASS, TYPE_DARK),
        .catchRate = 60,
        .expYield = 166,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_GOURGEIST_AVERAGE] =
    {
        ...
        .baseSpAttack  = 58,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_GHOST, TYPE_GRASS, TYPE_FIRE),
        .catchRate = 60,
        .expYield = 173,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_AVALUGG] =
    {
        ...
        .baseSpAttack  = 44,
        .baseSpDefense = 46,
        .types = MON_TYPES(TYPE_ICE, TYPE_STEEL, TYPE_GROUND),
        .catchRate = 55,
        .expYield = 180,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_AVALUGG_HISUIAN] =
    {
        ...
        .baseSpAttack  = 34,
        .baseSpDefense = 36,
        .types = MON_TYPES(TYPE_ICE, TYPE_STEEL, TYPE_ROCK),
        .catchRate = 55,
        .expYield = 180,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_FLYING, TYPE_DRAGON, TYPE_NORMAL),
        .catchRate = 190,
        .expYield = 49,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_XERNEAS_NEUTRAL] =
    {
        ...
        .baseSpAttack  = 131,
        .baseSpDefense = 98,
        .types = MON_TYPES(TYPE_FAIRY, TYPE_GRASS, TYPE_STEEL),
        .catchRate = 45,
    ...
    [SPECIES_YVELTAL] =
    {
        ...
        .baseSpAttack  = 131,
        .baseSpDefense = 98,
        .types = MON_TYPES(TYPE_DARK, TYPE_FLYING, TYPE_POISON),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 340 : 306,
        .evYield_HP = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_ZYGARDE_50_AURA_BREAK] =
    {
        ...
        .baseSpAttack  = 81,
        .baseSpDefense = 95,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_GROUND, TYPE_POISON),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_HP = 3,
        .genderRatio = MON_GENDERLESS,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AURA_BREAK, ABILITY_NONE, ABILITY_POWER_CONSTRUCT },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_ZYGARDE_10_AURA_BREAK]      =
    {
        ...
        .baseSpAttack  = 61,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_GROUND, TYPE_NORMAL),
        .catchRate = 3,
    ...
    [SPECIES_ZYGARDE_COMPLETE] =
    {
        ...
        .baseSpAttack  = 91,
        .baseSpDefense = 95,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_GROUND, TYPE_STEEL),
        .catchRate = 3,
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 150,
        .types = MON_TYPES(TYPE_ROCK, TYPE_FAIRY, TYPE_ELECTRIC),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_Defense = 1,
        .evYield_SpDefense = 2,
        ...
        .description = COMPOUND_STRING(
            ...
            "by using strong a electromagnetic force\n"
            "to compress the carbon in the air\n"
            "between its hands."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
    ...
    [SPECIES_HOOPA_CONFINED] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 130,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_GHOST, TYPE_STEEL),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_HOOPA_UNBOUND] =
    {
        ...
        .baseSpAttack  = 170,
        .baseSpDefense = 130,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_DARK, TYPE_FIGHTING),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_FIRE, TYPE_WATER, TYPE_STEEL),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
