...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .baseSpAttack  = 83,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FAIRY, TYPE_DRAGON),
        .catchRate = 45,
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .baseSpAttack  = 109,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_FIRE, TYPE_DARK, TYPE_GROUND),
        .catchRate = 45,
    ...
    [SPECIES_TYPHLOSION_HISUIAN] =
    {
        ...
        .baseSpAttack  = 119,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_FIRE, TYPE_GHOST, TYPE_POISON),
        .catchRate = 45,
        .expYield = TYPHLOSION_EXP_YIELD,
        .evYield_SpAttack = 3,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .baseSpAttack  = 79,
        .baseSpDefense = 83,
        .types = MON_TYPES(TYPE_WATER, TYPE_DARK, TYPE_ELECTRIC),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 265,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .description = COMPOUND_STRING(
            ...
            "and powerful hind legs to charge up energy\n"
            "and tackle the foe with lightning speed."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_BUG, TYPE_GROUND),
        .catchRate = 255,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .baseSpDefense = 96,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING, TYPE_GHOST),
        .catchRate = 90,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING, TYPE_FIGHTING),
        .catchRate = 90,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON, TYPE_GHOST),
        .catchRate = 90,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 140,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .baseSpAttack  = 56,
        .baseSpDefense = 56,
        .types = MON_TYPES(TYPE_WATER, TYPE_ELECTRIC, TYPE_FAIRY),
        .catchRate = 190,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .baseSpAttack  = 120,
        .baseSpDefense = 115,
        .types = MON_TYPES(TOGEPI_FAMILY_TYPE, TYPE_FLYING, TYPE_STEEL),
        .catchRate = 30,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 273,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_XATU] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_FLYING, TYPE_GRASS),
        .catchRate = 75,
        ...
        .description = COMPOUND_STRING(
            ...
            "emissaries from of mother earth."),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 318,
        .trainerOffset = 4,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .baseSpAttack  = 115,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_FAIRY, TYPE_DRAGON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 255,
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FAIRY, TYPE_WATER),
    #else
    ...
    [SPECIES_MARILL] =
    {
        ...
        .baseSpDefense = 50,
    #if P_UPDATED_TYPES >= GEN_6
        .types = MON_TYPES(TYPE_NORMAL, TYPE_WATER, TYPE_FAIRY),
    #else
        .types = MON_TYPES(TYPE_WATER),
    #endif
        .catchRate = 190,
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .baseSpDefense = 80,
    #if P_UPDATED_TYPES >= GEN_6
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_WATER, TYPE_FAIRY),
    #else
        .types = MON_TYPES(TYPE_WATER),
    #endif
        .catchRate = 75,
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_ROCK, TYPE_GRASS, TYPE_DARK),
        .catchRate = 65,
        ...
        .weight = 380,
        .description = COMPOUND_STRING(
            "Apparently, the larger the green parts\n"
            "of this Pokémon, the more collectors value\n"
            "it. It's a particular favorite among\n"
            "elderly people."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_FLYING, TYPE_POISON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 230,
    #elif P_UPDATED_EXP_YIELDS >= GEN_6
        ...
        .description = COMPOUND_STRING(
            ...
            "make more offspring. Breathing in this\n"
            "pollen can cause illness."),
        .pokemonScale = 418,
        .pokemonOffset = -4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 66,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_GRASS, TYPE_WATER),
        .catchRate = 45,
        ...
        .weight = 203,
        .description = COMPOUND_STRING(
            "They live on large trees in tropical\n"
            "rainforests. When others enter their\n"
            "territory they attack with fruits and\n"
            "water to chase them off."),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FIRE, TYPE_PSYCHIC),
        .catchRate = 120,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .baseSpAttack  = 116,
        .baseSpDefense = 56,
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING, TYPE_DRAGON),
        .catchRate = 30,
    ...
    [SPECIES_QUAGSIRE] =
    {
        ...
        .weight = 750,
        .description = COMPOUND_STRING(
            "It has an easygoing nature. The lack of\n"
            "concern has allowed it to awaken to a latent\n"
            "psychic power, though it does not like using\n"
            "it as it requires too much effort."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CLODSIRE] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_POISON, TYPE_GROUND, TYPE_WATER),
        .catchRate = 90,
        .expYield = 151,
        .evYield_HP = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_MISMAGIUS] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_GHOST, TYPE_FAIRY, TYPE_POISON),
        .catchRate = 45,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    {                                                                                                   \
        ...
        .baseSpAttack  = 72,                                                                            \
        .baseSpDefense = 48,                                                                            \
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_GHOST, TYPE_FLYING),                                      \
        .catchRate = 225,                                                                               \
    ...
    [SPECIES_WOBBUFFET] =
    {
        ...
        .baseSpAttack  = 33,
        .baseSpDefense = 58,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_GROUND, TYPE_POISON),
        .catchRate = 45,
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_PSYCHIC, TYPE_BUG),
        .catchRate = 60,
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_BUG, TYPE_ELECTRIC, TYPE_STEEL),
        .catchRate = 75,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_BUG, TYPE_DRAGON),
        .catchRate = 190,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_GROUND, TYPE_FLYING, TYPE_POISON),
        .catchRate = 60,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_SAND_VEIL, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .baseSpDefense = 60,
    #if P_UPDATED_TYPES >= GEN_6
        .types = MON_TYPES(TYPE_FAIRY, TYPE_GROUND, TYPE_FIGHTING),
    #else
        .types = MON_TYPES(TYPE_NORMAL),
    #endif
        .catchRate = 75,
    ...
    [SPECIES_QWILFISH_HISUIAN] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_DARK, TYPE_POISON, TYPE_WATER),
        .catchRate = 45,
        .expYield = QWILFISH_EXP_YIELD,
        .evYield_Attack = 1,
        .itemRare = ITEM_POISON_BARB,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .baseSpAttack  = 10,
        .baseSpDefense = 230,
        .types = MON_TYPES(TYPE_BUG, TYPE_ROCK, TYPE_STEEL),
        .catchRate = 190,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 95,
        .types = MON_TYPES(TYPE_BUG, TYPE_FIGHTING, TYPE_NORMAL),
        .catchRate = 45,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_DARK, TYPE_ICE, TYPE_STEEL),
        .catchRate = 45,
        ...
        .description = COMPOUND_STRING(
            ...
            "and rocks with metal claws. They bring\n"
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_POISON, TYPE_ICE),
        .catchRate = 20,
        .expYield = 102,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_GROUND, TYPE_NORMAL, TYPE_PSYCHIC),
        .catchRate = 20,
        .expYield = 275,
        .evYield_Attack = 3,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_URSALUNA_BLOODMOON] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_GROUND, TYPE_NORMAL, TYPE_GHOST),
        .catchRate = 5,
        .expYield = 275,
        .evYield_SpAttack = 3,
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_FIRE, TYPE_POISON, TYPE_ROCK),
        .catchRate = 75,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_ICE, TYPE_GROUND, TYPE_FIGHTING),
        .catchRate = 50,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 265,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .weight = 2910,
        .description = COMPOUND_STRING(
            "It looks strong, and that's exactly what\n"
            "it is. As the weather grows colder, its\n"
            "ice tusks grow longer, thicker, and\n"
            "more impressive."),
        .pokemonScale = 257,
        .pokemonOffset = 6,
        .trainerScale = 423,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER, TYPE_ROCK, TYPE_FAIRY),
        .catchRate = 60,
    ...
    [SPECIES_CORSOLA_GALARIAN] =
    {
        ...
        .types = MON_TYPES(TYPE_GHOST, TYPE_WATER, TYPE_ROCK),
        .catchRate = 60,
        .expYield = CORSOLA_EXP_YIELD,
        .evYield_SpDefense = 1,
        .genderRatio = PERCENT_FEMALE(75),
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_WATER, TYPE_DRAGON, TYPE_GRASS),
        .catchRate = 75,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_ICE, TYPE_FLYING, TYPE_FAIRY),
        .catchRate = 45,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 140,
        .types = MON_TYPES(TYPE_WATER, TYPE_FLYING, TYPE_POISON),
        .catchRate = 25,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 170,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .weight = 2200,
        .description = COMPOUND_STRING(
            "It once adapted to have poisonous skin\n"
            "to deter the Remoraid attached to it.\n"
            "As a result, Remoraid evolved to resist\n"
            "most poisons."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_STEEL, TYPE_FLYING, TYPE_GHOST),
        .catchRate = 25,
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_DARK, TYPE_FIRE, TYPE_GHOST),
        .catchRate = 45,
        ...
        .description = COMPOUND_STRING(
            ...
            "role. Upon hearing its eerie howls, other\n"
            "Pokémon return straight to their nests."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_GROUND, TYPE_ICE, TYPE_ROCK),
        .catchRate = 60,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 175 : 189,
        .evYield_Attack = 1,
        .evYield_Defense = 1,
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_PSYCHIC, TYPE_ICE),
        .catchRate = 45,
        .expYield = 263,
        .evYield_Attack = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .baseSpAttack  = 20,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_POISON, TYPE_STEEL),
        .catchRate = 45,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_WATER, TYPE_STEEL),
        .catchRate = 45,
        ...
        .description = COMPOUND_STRING(
            ...
            "grown-ups alike. Miltank's skin can react\n"
            "with the milk to turn it into a metal barrier."),
        .pokemonScale = 280,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .baseSpAttack  = 115,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_DARK, TYPE_PSYCHIC),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_FIRE, TYPE_GROUND, TYPE_NORMAL),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_WATER, TYPE_ICE, TYPE_FLYING),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .description = COMPOUND_STRING(
            ...
            "the land with gliding elegance. It is known\n"
            "as the reincarnation of the northern wind."),
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_ROCK, TYPE_GROUND, TYPE_FIGHTING),
        .catchRate = 45,
        .expYield = 144,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_ROCK, TYPE_DARK, TYPE_FIGHTING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 154,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_FLYING, TYPE_WATER),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 340,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 154,
        .types = MON_TYPES(TYPE_FIRE, TYPE_FLYING, TYPE_PSYCHIC),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 340,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_GRASS, TYPE_WATER),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
