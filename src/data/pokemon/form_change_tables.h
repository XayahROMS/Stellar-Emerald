...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_SUNNY, B_WEATHER_SUN, ABILITY_FAULTY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_RAINY, B_WEATHER_RAIN, ABILITY_FAULTY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_SNOWY, B_WEATHER_HAIL | B_WEATHER_SNOW, ABILITY_FAULTY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW), ABILITY_FAULTY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, B_WEATHER_NONE, ABILITY_FAULTY_FORECAST},
#else
...
static const struct FormChange sMeloettaFormChangeTable[] = {
    //{FORM_CHANGE_FAINT,         SPECIES_MELOETTA_ARIA}, Commented, might come back later or in case of bug
